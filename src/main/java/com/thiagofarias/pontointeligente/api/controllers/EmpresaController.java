...
import com.thiagofarias.pontointeligente.api.dtos.EmpresaDto;
...
public class EmpresaController {
	...
	private EmpresaDto converterEmpresaDto(Empresa empresa) {
		...
		empDto.setId(empresa.getId());
		empDto.setCnpj(empresa.getCnpj());
		empDto.setRazaoSocial(empresa.getRazaoSocial());
