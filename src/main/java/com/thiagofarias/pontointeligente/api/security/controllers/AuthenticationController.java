package com.thiagofarias.pontointeligente.api.security.controllers;
...
import com.thiagofarias.pontointeligente.api.security.dto.JwtAuthenticationDto;
import com.thiagofarias.pontointeligente.api.security.dto.TokenDto;
...
public class AuthenticationController {
	...
	public ResponseEntity<Response<TokenDto>> gerarRefreshTokenJwt(HttpServletRequest request) {
		...
		if (!token.isPresent()) {
			...
			response.getErrors().add("Token inválidp ou expirado");
		}
